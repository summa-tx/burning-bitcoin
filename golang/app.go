...
// NewBurnApp instantiates a new Bitcoin burning app
func NewBurnApp(
	...
	app.mm = module.NewManager(
		...
		burn.NewAppModule(app.burnKeeper, app.bankKeeper),
...
func (app *burnApp) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *burnApp) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
	return app.mm.BeginBlock(ctx, req)
}

func (app *burnApp) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	return app.mm.EndBlock(ctx, req)
}

func (app *burnApp) LoadHeight(height int64) error {
	return app.LoadVersion(height, app.keys[bam.MainStoreKey])
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *burnApp) ModuleAccountAddrs() map[string]bool {
...
func (app *burnApp) ExportAppStateAndValidators(forZeroHeight bool, jailWhiteList []string,
